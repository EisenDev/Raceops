...
export function CodeRunnerForm({ teams, selectedLanguage, assignedTeam, state, action, isPending }: CodeRunnerFormProps) {
        ...
        <form action={action} className="space-y-8">
          ...
          {!isLocked && (
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground opacity-30 ml-1">Team Selection</label>
              <select 
                name="teamId" 
                required
                value={teamId}
          ...
          {isLocked && (
            <div className="space-y-2">
              ...
              <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground opacity-30 ml-1">Active Team</label>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground opacity-30 ml-1">Mission Source Code</label>
          ...
          >
            {isPending ? (
              <div className="flex items-center gap-2">
                ...
                <span>Processing mission parameters...</span>
              </div>
            ) : (
